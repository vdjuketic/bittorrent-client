...
def test_encode_nested_lists():
    assert encode_bencode(["hello",123,["abc", 456],]) == b"l5:helloi123el3:abci456eee"
...
def test_encode_nested_dictionary():
    ...
    assert encode_bencode(data) == b"d10:inner_dictd4:key16:value14:key2i42e8:list_keyl5:item15:item2i3eeee"
